...
NppSync uses a classic `.csproj` targeting .NET Framework 4.8. Use `msbuild`, not `dotnet build`:
...
Output: `bin\Release\x64\NppSync.dll` and `bin\Release\x86\NppSync.dll`
